//$(document).ready(function(){
  ...
  var taiwan = document.getElementById("taiwan"),
      ...
      phil = document.getElementById("phil"),
      thai = document.getElementById("thai"),
      jap = document.getElementById("japan");


taiwan.addEventListener("click", function(){
  window.location.href= "../Taiwan/index.html";
});
...
china.addEventListener("click", function(){
  window.location.href= "../China/index.html"
});
...
phil.addEventListener("click", function(){
  window.location.href= "../Philippines/index.html"
});

thai.addEventListener("click", function(){
  window.location.href= "../Thailand/index.html"
});
